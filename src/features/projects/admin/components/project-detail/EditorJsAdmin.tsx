...
import { getAdminStoryPreviewUrl } from '@/entities/projects/lib/admin-story-preview-url';
import {
  type EditorOutput,
  type I18nLocale,
...
import {
  ...
  parseStoryContent,
} from '@/entities/project-detail-page/lib/story-content-document';
import { normalizeStoryParagraphBlocks } from '@/entities/project-detail-page/lib/paragraph-html';
...
} from '@/features/projects/admin/editor/locale-context';
import {
...
import { attachEditorImagePaste } from '@/features/projects/admin/editor/editor-image-paste';
import { attachEditorCodePaste } from '@/features/projects/admin/editor/editor-code-paste';
import { attachEditorI18nEnterSplit } from '@/features/projects/admin/editor/editor-i18n-enter-split';
import { attachEditorMarkdownShortcuts } from '@/features/projects/admin/editor/editor-markdown-shortcuts';
import { attachEditorInlineCode } from '@/features/projects/admin/editor/editor-inline-code';
import { attachEditorUndo } from '@/features/projects/admin/editor/editor-undo';
import { STORY_CONTENT_SHELL_CLASS } from '@/constants/story-layout';
import { LocaleTabSwitcher } from './LocaleTabSwitcher';
import { StoryEditorVisibilityToggle } from '@/features/projects/admin/components/project-detail/StoryEditorVisibilityToggle';
      ...
      try {
        const [{ default: EditorJs }, { createEditorTools }] =
          await Promise.all([
            ...
            import('@/features/projects/admin/editor/editor-config'),
          ]);
  ...
  return (
    <div className={`${STORY_CONTENT_SHELL_CLASS} space-y-6 py-4`}>
      <header className='space-y-4 border-b border-zinc-200 pb-6 dark:border-zinc-800'>
        ...
        <p className='text-sm text-zinc-400'>{t('detailEditorLayoutHint')}</p>
        <Link
